...
class BitmapEditor
  ...
  def run(file)
    ...
    File.open(file).each do |line|
      ...
      when 'I'
        # Init command
        break unless args_correct?(args, 3, "I N M")
      ...
      when 'L'
        ...
        break unless bitmap_present?(bitmap) && args_correct(args, 4, "L X Y C")
      ...
      when 'V'
        ...
        break unless bitmap_present?(bitmap) && args_correct(args, 5, "V X Y1 Y2 C")
      ...
      when 'H'
        ...
        break unless bitmap_present?(bitmap) && args_correct(args, 5, "H X1 X2 Y C")
