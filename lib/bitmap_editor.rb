  ...
  def run(file)
    ...
    File.readlines(file).each do |line|
      ...
      when 'L'
        ...
        begin
          bitmap.set_colour(args[1].to_i, args[2].to_i, args[3])
        rescue ArgumentError => err
          puts 'Argument error: ' + err.message
        end
      when 'V'
        ...
        begin
          bitmap.vertical_segment(args[1].to_i, args[2].to_i, args[3].to_i, args[4])
        rescue ArgumentError => err
          puts 'Argument error: ' + err.message
        end
      when 'H'
        ...
        begin
          bitmap.horizontal_segment(args[1].to_i, args[2].to_i, args[3].to_i, args[4])
        rescue ArgumentError => err
          puts 'Argument error: ' + err.message
        end
      when 'F'
